...
class SoundManager {
  ...
  // Coin inserted sound (Arcade classic high double chime)
  public playCoin() {
  ...
  // Explosion (Invader killed / Ship destroyed)
  ...
  // Project Discovered Fanfare (Chiptune arpeggio)
